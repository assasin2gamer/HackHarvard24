...
import { Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Collapse, IconButton, Typography, Paper } from '@mui/material';
...
const rows = [
  createData('Vitamin B', '75%', 'This is the expandable detailed explanation for Heart Disease.'),
  createData('Magnesium', '60%', 'This is the expandable detailed explanation for Diabetes.'),
  createData('Iron', '50%', 'This is the expandable detailed explanation for Hypertension.'),
  createData('B-complex', '30%', 'This is the expandable detailed explanation for Asthma.'),
];
...
function Prediction() {
  ...
  return (
    <Grid>
      ...
      {/* Right side: Disease Predictions Table */}
